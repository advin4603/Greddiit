...
const postSchema = new Schema({
  title: {type: String, required: [true, "Title is required"],  minLength: [1, "Title is required"]},
  post: {type: String, required: [true, "Post is required"], minLength: [1, "Post is required"]},
