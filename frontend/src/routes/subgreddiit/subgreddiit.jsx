...
import {Avatar, Card, Spacer, Text, Grid, Button, Badge, Link as LinkDisplay, Tooltip} from "@nextui-org/react";
...
function SubgredditInfo({subgreddiit, tab}) {
  ...
  if (subgreddiit.moderator.username === username) {
    tabs = [
      [<PostIcon/>, "Posts", <Posts cardStyle={cardStyle} subgreddiitTitle={subgreddiit.title}
                                    bannedKeywords={subgreddiit.bannedKeywords}/>, "Ctrl+Alt+P"],
      [<UsersIcon/>, "Users", <Users cardStyle={cardStyle} subgreddiit={subgreddiit}/>, "Ctrl+Alt+U"],
      [<RequestsIcon/>, "Join Requests", <Requests cardStyle={cardStyle} subgreddiit={subgreddiit}/>, "Ctrl+Alt+J"],
      [<StatsIcon/>, "Stats", <Stats cardStyle={cardStyle} subgreddiit={subgreddiit}/>, "Ctrl+Alt+S"],
      [<ReportIcon/>, "Reports", <Reports subgreddiit={subgreddiit} cardStyle={cardStyle}/>, "Ctrl+Alt+R"],
      [<SettingsIcon/>, "Settings", <Settings cardStyle={cardStyle} subgreddiit={subgreddiit}/>, "Ctrl+Alt+O"]
    ];
    notJoined = false
  } else if (subgreddiit.followers !== undefined) {
    tabs = [
      [<PostIcon/>, "Posts", <Posts cardStyle={cardStyle} subgreddiitTitle={subgreddiit.title}/>, "Ctrl+Alt+P"],
      [<UsersIcon/>, "Users", <Users cardStyle={cardStyle} subgreddiit={subgreddiit}/>, "Ctrl+Alt+U"]
    ];
    notJoined = false
  ...
  useHotkeys("ctrl+alt+r", () => {
    navigate({
      ...
      search: `?${createSearchParams([["tab", "Reports"]])}`
    })
  })
  ...
  useHotkeys("ctrl+alt+o", () => {
    navigate({
      pathname: `/g/${subgreddiit.title}`,
      search: `?${createSearchParams([["tab", "Settings"]])}`
    })
  })
  ...
  useHotkeys("ctrl+alt+s", () => {
    navigate({
      pathname: `/g/${subgreddiit.title}`,
      search: `?${createSearchParams([["tab", "Stats"]])}`
    })
  })
  useHotkeys("ctrl+alt+j", () => {
    navigate({
      pathname: `/g/${subgreddiit.title}`,
      search: `?${createSearchParams([["tab", "Join Requests"]])}`
    })
  })
  useHotkeys("ctrl+alt+u", () => {
    navigate({
      pathname: `/g/${subgreddiit.title}`,
      search: `?${createSearchParams([["tab", "Users"]])}`
    })
  })
  useHotkeys("ctrl+alt+p", () => {
    navigate({
      pathname: `/g/${subgreddiit.title}`,
      search: `?${createSearchParams([["tab", "Posts"]])}`
    })
  })
